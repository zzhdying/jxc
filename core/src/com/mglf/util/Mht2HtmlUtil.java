...
public class Mht2HtmlUtil {
	...
	final static private String FILE_ENCODE = "UTF-8";
	
	private final static Log log = LogFactory.getLog(Mht2HtmlUtil.class);

	
	public static void main(String[] args) {
//		byte[] result = Mht2HtmlUtil.mht2html("d:\\a.doc", "d:\\test.html");
//		System.out.print(result);
	 ...
	 * @param s_DescHtml
	 */
	public static InputStream mht2html(InputStream fis, String s_DescHtml) {
		try {
//			InputStream fis = new FileInputStream(s_SrcMht);
			...
			if (content instanceof Multipart) {
				...
				strEncodng = strEncodng == null ? FILE_ENCODE : strEncodng;
...
//				}
				...
				// 最后保存HTML文件
				//SaveHtml(strText, s_DescHtml, FILE_ENCODE);
				return new ByteArrayInputStream(strText.getBytes(strEncodng));
			} else {
				return null;
			}
		} catch (Exception e) {
			log.error("mht2html", e);
		}
		return null;
	}
