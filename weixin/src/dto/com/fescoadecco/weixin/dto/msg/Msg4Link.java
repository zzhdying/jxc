...
public class Msg4Link extends Msg {
	...
	public void read(Document document) {
		this.title = document.getElementsByTagName("Title").item(0)
				.getTextContent();
		this.description = document.getElementsByTagName("Description").item(0)
				.getTextContent();
		this.url = document.getElementsByTagName("Url").item(0)
				.getTextContent();
