...
import com.fescoadecco.weixin.session.Session;
...
public class Msg4Head {
	...
	public void read(Document document) {
		this.toUserName = document.getElementsByTagName("ToUserName").item(0)
				.getTextContent();
		this.fromUserName = document.getElementsByTagName("FromUserName")
				.item(0).getTextContent();
		this.createTime = document.getElementsByTagName("CreateTime").item(0)
				.getTextContent();
		this.msgType = document.getElementsByTagName("MsgType").item(0)
				.getTextContent();
	}
