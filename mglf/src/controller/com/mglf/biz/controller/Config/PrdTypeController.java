...
@Controller
@RequestMapping("/prdtype")
public class PrdTypeController {
	...
	public ModelAndView idx() throws Exception {
		...
		List<Dic> dicList = dicService.getDicByCode(Dic.PRD_TYPE, loginUser.getEntid());
		map.put("diclist", dicList);
		return new ModelAndView("web/prdtype/index.jsp", map);
	}
	
	@RequestMapping("/add")
	public ModelAndView add() throws Exception {
		ModelMap map = new ModelMap();
		return new ModelAndView("web/prdtype/add.jsp", map);
	}
	
	@RequestMapping("/adddo")
	public ModelAndView adddo(Dic dic) throws Exception {
		ModelMap map = new ModelMap();
		dic.setCode(Dic.PRD_TYPE);
		dicService.add(dic);
		staticValueService.initStaticValueString();
		return new ModelAndView("redirect:/prdtype/index", map);
	}
	...
	public ModelAndView edit(@PathVariable("id") String id) throws Exception {
		...
		return new ModelAndView("web/prdtype/edit.jsp", map);
	}
	...
	public ModelAndView editdo(Dic dic) throws Exception {
		...
		staticValueService.initStaticValueString();
		return new ModelAndView("redirect:/prdtype/index");
	}
