...
!function ( $ ) {
  ...
  , show: function () {
      ...
      if (that.values.length) {
    	  if(that.options.data.length > 0){
    		  $.each(that.values,function(idx ,value){
    			  $.each(that.options.data,function(i,v){
    				  if(value == v){
    					  that.createBadge(that.options.source[i]);
    				  }
    			  });
    		  });
    	  }else{
  ...
  , add: function ( value ) {
      var that = this;
      if(that.options.maxSize != ''){
    	  if(this.values.length >= that.options.maxSize){
    		  return;
    	  }
      }
      ...
      if(that.options.caseInSource){
    	  ...
    	  if(that.options.data.length > 0){
    		  actvalue = that.options.data[index];
          }
      }
      if(actvalue!=null && actvalue != ''){
    	  this.values.push(actvalue);
      }else{
