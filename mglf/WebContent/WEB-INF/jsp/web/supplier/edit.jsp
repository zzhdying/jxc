				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="${root }/supplier/editdo" method="post" class="form-horizontal" id="unitform">
								<input type="hidden" name="id" value="${dic.id }"/>
								<input type="hidden" name="entid" value="${dic.entid }"/>
								<input type="hidden" name="num" value="${dic.num }">
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="entname"> 供应商名称 </label>
									<div class="col-sm-9">
										<input type="text" id="entname" name="entname" value="${dic.entname }" tabindex="1" placeholder="供应商名称 " class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="name" name="name" value="${dic.name }" tabindex="2" placeholder="联系人" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="linkphone" name="linkphone" value="${dic.linkphone }" tabindex="3" placeholder="联系电话" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="address" name="address" value="${dic.address }" tabindex="4" placeholder="供应商地址" class="col-xs-10 col-sm-5" />
									</div>
								</div>
