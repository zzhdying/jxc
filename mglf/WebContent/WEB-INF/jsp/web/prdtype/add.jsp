...
<c:set var="curmenu" value="prdtype"></c:set>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="${root }/prdtype/adddo" method="post" class="form-horizontal" id="unitform">
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="unitid"> 编号 </label>
									<div class="col-sm-9">
										<input type="text" id="unitid" name="num" tabindex="1" placeholder="编号可以让您更方便找到该商品类别  如：001、002、003" class="col-xs-10 col-sm-5" value=""/>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 类别名称 </label>
									<div class="col-sm-9">
										<input type="text" name="name" tabindex="2" placeholder="类别名称" class="col-xs-10 col-sm-5" />
									</div>
								</div>
