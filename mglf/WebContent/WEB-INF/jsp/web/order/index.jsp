			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="m-b-10x">
								<a href="${root }/order/add" class="btn btn-default radius-4">
									...
									<tbody>
										<c:forEach items="${list }" var="item">
											<tr data-key="${item.id }">
												...
												<td>
													<c:if test="${empty item.isOk || item.isOk==0 }"><span class="red">未确认</span></c:if> 
													<c:if test="${empty item.isOk || item.isOk==1 }"><span class="green">已确认</span></c:if> 
												</td>
												<td align="center">
													<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
														...
														<button class="btn btn-xs btn-danger del-btn" data-key="${item.id }">
		...
		<script type="text/javascript">
			jQuery(function($) {
				$("#sample-table-1 tr").dblclick(function(){
					location.href = "${root}/order/edit/"+$(this).attr("data-key");
				});
