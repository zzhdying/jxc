...
<body class="login-layout">
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='/jxc/static/assets/js/jquery-2.0.3.min.js'>"+"<"+"/script>");
		</script>
...
<![endif]-->
		...
		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='/jxc/static/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
